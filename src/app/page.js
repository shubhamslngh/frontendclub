...
const stats = [
  ...
  { label: "Club Members", value: "0+" },
  { label: "Commercials", value: "0" },
];
...
export default function Home() {
  return (
    ...
    >
      <header className="sticky top-0 z-20 border-b border-[color:var(--kk-line)] bg-[color:var(--kk-sand)]/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium lg:flex">
            <a className="hover:text-[color:var(--kk-ember)]" href="#services">Services</a>
            <a className="hover:text-[color:var(--kk-ember)]" href="#photos">Photos</a>
            <a className="hover:text-[color:var(--kk-ember)]" href="#products">Products</a>
            <a className="hover:text-[color:var(--kk-ember)]" href="#news">News</a>
            <a className="hover:text-[color:var(--kk-ember)]" href="#contact">Contact</a>
          </nav>
          <div className="flex items-center gap-3">
            <Link
              href="/login"
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-[radial-gradient(circle_at_center,_rgba(214,107,45,0.35),_transparent_70%)] blur-2xl" />
            ...
            <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-[radial-gradient(circle_at_bottom,_rgba(255,247,232,0.9),_transparent_65%)] blur-2xl" />
          </div>
          <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-20 lg:flex-row lg:items-center">
            <div className="flex-1 space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
              <p className="text-sm font-semibold uppercase tracking-[0.4em] text-[color:var(--kk-field)]">
              ...
              <h1 className={`text-5xl font-semibold uppercase leading-none sm:text-6xl lg:text-7xl ${displayFont.className}`}>
                Fueling Passion,
                <span className="block text-[color:var(--kk-ember)]">Building Champions.</span>
              </h1>
              <p className="max-w-xl text-lg text-[color:var(--kk-ink)]/80">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="#contact"
                  className="rounded-full bg-[color:var(--kk-ember)] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-90"
                >
                  Join Us Now
                </Link>
                <Link
                  href="#services"
                  className="rounded-full border border-[color:var(--kk-field)] px-6 py-3 text-sm font-semibold text-[color:var(--kk-field)] transition hover:bg-[color:var(--kk-field)] hover:text-white"
                >
                  View Services
                </Link>
              </div>
            ...
            >
              <div className="rounded-3xl border border-[color:var(--kk-line)] bg-[color:var(--kk-cream)] p-6 shadow-sm">
                <p className="text-xs uppercase tracking-[0.4em] text-[color:var(--kk-field)]">Training</p>
                <p className={`mt-3 text-3xl uppercase ${displayFont.className}`}>Net Sessions</p>
                <p className="mt-4 text-sm text-[color:var(--kk-ink)]/70">
                  Weekly drills focused on fundamentals, reflexes, and match readiness.
                </p>
              </div>
              <div className="rounded-3xl border border-[color:var(--kk-line)] bg-white p-6 shadow-sm">
                <p className="text-xs uppercase tracking-[0.4em] text-[color:var(--kk-field)]">Facilities</p>
              ...
              <div className="rounded-3xl border border-[color:var(--kk-line)] bg-white p-6 shadow-sm sm:col-span-2">
                <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-xs uppercase tracking-[0.4em] text-[color:var(--kk-field)]">Club Promise</p>
                    <p className={`mt-3 text-3xl uppercase ${displayFont.className}`}>
                      Community and Competition
                    </p>
                    <p className="mt-4 max-w-xl text-sm text-[color:var(--kk-ink)]/70">
                      We create a space where beginners find guidance and experienced players sharpen their edge.
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-center">
                    {stats.map((stat) => (
                      <div key={stat.label} className="rounded-2xl border border-[color:var(--kk-line)] bg-[color:var(--kk-cream)] px-4 py-3">
                        <p className={`text-2xl uppercase ${displayFont.className}`}>{stat.value}</p>
                        <p className="text-[11px] uppercase tracking-[0.3em] text-[color:var(--kk-field)]">
                          {stat.label}
                        </p>
                      </div>
                    ))}
        ...
        <section id="services" className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-md text-sm text-[color:var(--kk-ink)]/70">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="group rounded-3xl border border-[color:var(--kk-line)] bg-white p-6 shadow-sm transition hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-6 duration-700"
                style={{ animationDelay: `${index * 120}ms` }}
              >
                <p className={`text-2xl uppercase ${displayFont.className}`}>{service.title}</p>
                <p className="mt-4 text-sm text-[color:var(--kk-ink)]/70">{service.description}</p>
                <div className="mt-6 h-1 w-12 rounded-full bg-[color:var(--kk-ember)] transition group-hover:w-20" />
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="photos" className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <Link
              href="#contact"
              className="text-sm font-semibold text-[color:var(--kk-ember)]"
            >
              View All Photos
            </Link>
          </div>
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {photoSets.map((photo, index) => (
              <div
                key={photo.title}
                className={`relative h-44 overflow-hidden rounded-3xl bg-gradient-to-br ${photo.tone} p-4 text-white shadow-sm animate-in fade-in slide-in-from-bottom-6 duration-700`}
              ...
              >
                ...
                <div className="relative flex h-full flex-col justify-between">
                  ...
                  <p className={`text-2xl uppercase ${displayFont.className}`}>{photo.title}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section id="products" className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="rounded-3xl border border-[color:var(--kk-line)] bg-white p-10 shadow-sm">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              {products.map((product, index) => (
                <div
                  key={product.title}
                  className="rounded-2xl border border-[color:var(--kk-line)] bg-[color:var(--kk-cream)] p-6 animate-in fade-in slide-in-from-bottom-6 duration-700"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <p className={`text-2xl uppercase ${displayFont.className}`}>{product.title}</p>
                  <p className="mt-3 text-sm text-[color:var(--kk-ink)]/70">{product.detail}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="news" className="mx-auto w-full max-w-6xl px-6 py-16">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {["Match Fixtures", "Coaching Batches", "Ground Availability"].map((title, index) => (
              <div
                key={title}
                className="rounded-3xl border border-[color:var(--kk-line)] bg-white p-6 shadow-sm animate-in fade-in slide-in-from-bottom-6 duration-700"
                style={{ animationDelay: `${index * 120}ms` }}
              >
                <p className={`text-xl uppercase ${displayFont.className}`}>{title}</p>
                <p className="mt-3 text-sm text-[color:var(--kk-ink)]/70">
        ...
        <section id="contact" className="mx-auto w-full max-w-6xl px-6 pb-20">
          <div className="rounded-3xl border border-[color:var(--kk-line)] bg-[color:var(--kk-ember)] p-10 text-white shadow-sm">
            <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr]">
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                  <Link
                    href="/login"
                    className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[color:var(--kk-ember)]"
                  >
                    Member Login
                  </Link>
                  <Link
